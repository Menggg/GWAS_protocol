...
setwd("~/Downloads")
map=read.table("/Users/mh0986/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-SNP-MAP/HDRA-G6-4-final-snp-map.tsv",head=F)
bim=read.table("~/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-RDP1-RDP2-NIAS/HDRA-G6-4-RDP1-RDP2-NIAS.bim",head=F)
bim[,5:6]=map[,4:5]
write.table(bim,"~/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-RDP1-RDP2-NIAS/HDRA-G6-4-RDP1-RDP2-NIAS.bim",quote=F,row.names = F,col.names = F)

#convert PLINK format to VCF format
system("./plink2 --bfile ~/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-RDP1-RDP2-NIAS/HDRA-G6-4-RDP1-RDP2-NIAS --export vcf --out rice")
...
myGM=read.table("~/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-RDP1-RDP2-NIAS/HDRA-G6-4-RDP1-RDP2-NIAS.bim",head=F)[,c(2,1,4)]
trait1=read.table("/Users/mh0986/Dropbox/PROJECTS/GWAS_protocol/phenoAvLen_G6_4_RDP12_ALL/phenoAvLen_G6_4_RDP12_ALL.txt",head=T)
...
trait=read.delim("~/Dropbox/PROJECTS/GWAS_protocol/HDRA-G6-4-RDP1-RDP2-NIAS/HDRA-G6-4-RDP1-RDP2-NIAS-sativa-only.sample_map.rev2.tsv",head=F)
